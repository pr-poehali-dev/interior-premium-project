...
importуки для оптимизации р Container from "@/components/uiендеринга

Просто дайте знать,/Container";
import { Button } from "@/components/ui/button какой компонент вы";
import { useState } хотите добавить след from "react";

const portfolующим, и я егоioItems = [
  { разработаю!
    id: 1,
